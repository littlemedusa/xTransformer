...
class xTransformer_v0_1(nn.Module):

    def __init__(self, configs):
        super(xTransformer_v0_1, self).__init__()
        ...
        self.global_fusion = nn.Linear(self.patch_num*configs.d_model, configs.d_model)
        ...
        # Decoder
        self.dec = nn.Linear(configs.d_model, self.pred_len)
    ...
    def forward(self, x_batch, x_batch_mark, y_batch_zero, y_batch_mark):
        ...
        enc_n = self.global_fusion(enc_t)  # [B, N, d_model]
